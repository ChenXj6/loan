...
const base = {
  ...
  // loan
  loanIndex: apiUrl + 'userinfo&op=loanindex',
  subLoanOne: apiUrl + 'userinfo&op=submitloanone',
  subLoanTwo: apiUrl + 'userinfo&op=submitloantwo',
  subLoanThree: apiUrl + 'userinfo&op=submitloanthree',
  getAmountList: apiUrl + 'userinfo&op=loanamountlist',
  subLoanFour: apiUrl + 'userinfo&op=submitloanfour',
  submitloanfourconfirm : apiUrl + 'userinfo&op=submitloanfourconfirm',
  subLoanFive: apiUrl + 'userinfo&op=submitloanfive',
  getOrderStatus: apiUrl + 'userinfo&op=selectorderstatus',
  subLoanEnd : apiUrl + 'userinfo&op=submitloanend',
  backOne: apiUrl + 'userinfo&op=backone',

  submitloanpay: apiUrl + 'userinfo&op=submitloanpay',
  selectloanorderstatus: apiUrl + 'userinfo&op=selectloanorderstatus',
  nextloan: apiUrl + 'userinfo&op=nextloan',
  meloanstatus:apiUrl + 'userinfo&op=meloanstatus'
}
